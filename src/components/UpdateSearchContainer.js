...
import UpdateSearchCard from "./UpdateSearchCard"
import { SEARCH_URL, HEADERS, CORS} from "../constants"
import ListSearchBar from "./ListSearchBar"

class UpdateSearchContainer extends Component {
  constructor() {
    super()
    this.state = {
      searchTerm: "",
  ...
  fetchGames = (searchTerm) => {
    fetch(`${CORS}/${SEARCH_URL}${searchTerm}&fields=name,cover.url&limit=50`, {
      headers: HEADERS
    })
    .then(resp => resp.json())
...
export default UpdateSearchContainer
